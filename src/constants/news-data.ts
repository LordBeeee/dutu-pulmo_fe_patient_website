...
export const NEWS_CATEGORIES: { value: NewsCategory; label: string; color: string }[] = [
  { value: 'HOSPITAL', label: 'Tin bệnh viện', color: 'text-blue-600' },
  { value: 'MEDICAL', label: 'Kiến thức y khoa', color: 'text-green-600' },
  { value: 'PROMOTION', label: 'Tin khuyến mãi', color: 'text-orange-600' },
  { value: 'SYSTEM', label: 'Cập nhật hệ thống', color: 'text-purple-600' },
];
