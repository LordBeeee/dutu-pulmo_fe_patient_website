...
export function ProfileSidebar() {
  ...
  const avatarUrl = avatarPreview || profile?.avatarUrl || 'https://via.placeholder.com/150';
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Lịch khám', to: '/appointment-schedule', icon: 'calendar_today' },
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[100] px-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 w-full max-w-sm shadow-xl transition-colors scale-in-center">
            <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2">Xác nhận đăng xuất</h3>
            <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">Bạn có chắc chắn muốn đăng xuất khỏi tài khoản?</p>
