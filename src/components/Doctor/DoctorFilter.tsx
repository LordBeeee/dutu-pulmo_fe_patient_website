...
function DoctorFilter({ filters, onChange, onReset }: DoctorFilterProps) {
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                type="button"
                onClick={() =>
                  onChange({ ...filters, appointmentType: "all" })
                }
              ...
              <button
                type="button"
                onClick={() =>
                  onChange({ ...filters, appointmentType: "online" })
                }
                className={`py-2 text-sm rounded-lg border ${
              ...
              <button
                type="button"
                onClick={() =>
                  onChange({ ...filters, appointmentType: "offline" })
                }
                className={`py-2 text-sm rounded-lg border ${
